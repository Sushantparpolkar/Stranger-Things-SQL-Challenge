...
--Q2) Find characters with age greater than 18?
...
--Q4)Get details of the 'Mind Flayer' monster?

SELECT *
FROM Monsters
WHERE "name" = 'Mind Flayer';

--Q5) Retrieve characters and their associated events?

SELECT c.name, e.event_name
FROM Characters c
...
SELECT   hometown ,COUNT(character_id)AS Total_Characters
FROM
Characters
GROUP BY hometown;

--Q7) Retrieve characters who were involved in events in Season 1 or Season 2?

SELECT c.name,e.season
FROM
Characters c
JOIN Relationships r ON c.character_id = r.character1_id OR c.character_id = r.character2_id
JOIN Events e ON r.character1_id = e.event_id OR r.character2_id=e.event_id
...
--Q8) Find the top 3 oldest characters?
...
---Q9)Find the average age of characters in Hawkins?
...
--Q10)Rank characters by age in descending order?
